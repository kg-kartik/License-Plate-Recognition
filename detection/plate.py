...
def YOLO(image_list):
    ...
    configPath = "detection/cfg/alpr_tiny_test.cfg"
    weightPath = "detection/meta/alpr_tiny.weights"
    metaPath = "detection/data/alpr.data"
    ...
    while (i < len(image_list)):
        image = cv2.imread(os.path.join("detection/IMG_UPLOAD", image_list[i]))
        # print(image, "\n\n\n")
        width = image.shape[1]
...
def run_detections():
    image_list = os.listdir("detection/IMG_UPLOAD")
    img_list = []
